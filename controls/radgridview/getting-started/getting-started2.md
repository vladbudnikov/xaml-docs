...
>tip__ViewModelBase__ is an abstract class implementing __INotifyPropertyChanged__. It resides in the __Telerik.Windows.Controls__ namespace.
...
Alternatively, you can set the __ItemsSource__ property in code-behind, as demonstrated in __Example 6__.
...
#### __Figure 2: RadGridView Bound to a Collection of Clubs__
...
Running the code in __Example 7__ will generate the grid view shown in __Figure 3__. The XAML declaration of the __RadGridView__ contains two columns - the first column named "Club Name" is bound to the _Name_ property and the "Established" column is bound respectively to __Established__. As a result, your grid control <Comment: Why is this a grid control and not a grid view?> will have only two columns and no other column will be added because the __AutoGenerateColumns__ property is set to __False__.
